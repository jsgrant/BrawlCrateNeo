...
namespace BrawlCrate.Core.Extensions
{
    ...
    public static class Int32Extension
    {
        ...
        /// <returns>An Endian-swapped 32-bit integer.</returns>
        ...
        /// <summary>
        /// Converts a 32-bit integer from the current system Endianness to a given Endianness.
        /// </summary>
        /// <param name="i">The specified int.</param>
        /// <param name="convertTo">The Endianness to convert to.</param>
        /// <returns>An Endian-converted 32-bit integer.</returns>
        ...
        /// <summary>
        /// Converts a 32-bit integer from a given Endianness to the current system Endianness.
        /// </summary>
        /// <param name="i">The specified int.</param>
        ...
        /// <summary>
        /// Converts a 32-bit integer from a given Endianness to another given Endianness.
        /// </summary>
        /// <param name="i">The specified int.</param>
        /// <param name="convertFrom">The Endianness to convert from.</param>
        /// <param name="convertTo">The Endianness to convert to.</param>
